                  ...
                  <g id="layer1">
                    <g id="g60">
                      <g id="g36">
                        ...
                        <g id="g32">
                          ...
                          <g id="g22">
                            ...
                            <g id="path16">
                              <path className="cls-2" d="M407.99,319.2s5.64,.06,8.34-.2c1.96-.19,3.61-1.22,5.71-.4,1.25,.49,2.41,3,2.41,3,0,0-1.9,2.3-3.29,2.8-3.88,1.39-9.25,1.69-12.73-.4-.93-.56-1.3-1.78-1.32-2.8,0-.72,.88-2,.88-2h0Z"/>
                            ...
                            <g id="path18">
                              <path className="cls-2" d="M407.77,314.2s5.64,.06,8.34-.2c1.96-.19,4.7-1.62,6.8-.8,1.25,.49,2.41,3,2.41,3,0,0-1.9,2.3-3.29,2.8-3.88,1.39-10.35,2.09-13.83,0-.93-.56-1.3-1.78-1.32-2.8,0-.72,.88-2,.88-2h.01Z"/>
                            ...
                            <g id="path20">
                              <path className="cls-2" d="M407.77,308.6s5.64,.06,8.34-.2c1.96-.19,4.7-1.62,6.8-.8,1.25,.49,2.41,3,2.41,3,0,0-1.9,2.3-3.29,2.8-3.88,1.39-10.35,2.09-13.83,0-.93-.56-1.3-1.78-1.32-2.8,0-.72,.88-2,.88-2h.01Z"/>
                          ...
                          <g id="path24">
                            <path className="cls-2" d="M426.32,294.61h9.48l4.55-3.05-4.53-3.12h-9.48l-10.28-2.55-10.28,2.55h-10.02l-4.53,3.12,4.55,3.05h10.02l10.26,2.94,10.26-2.94Z"/>
                          ...
                          <g id="path28">
                            <path className="cls-2" d="M544.26,260.67c-20.33,0-37.05,15.02-37.05,33.75s16.71,33.84,37.05,33.84,37.15-15.1,37.15-33.84-16.82-33.75-37.15-33.75Z"/>
                          ...
                          <g id="path30">
                            <path className="cls-2" d="M414.22,399.13h226.04v-12.77h-226.04v12.77h0Z"/>
                      ...
                      <g id="g58">
                        ...
                        <g id="path46">
                          <path className="cls-2" d="M510.21,308.91l-2.67,1.4c-18.13,6.37-32.1,6.16-50.35,0l-2.6,6.67c-2.07,7.54-.93,14.18,1.9,19.54,1.73-.75,3.46-2.38,5.19-3.94,.85,2.6,.47,6.31,3.46,9.3,3.39-1.73,5.49-4.1,6.75-5.83,.58,3.56,2.07,6.26,5.06,8.2,3-1.93,4.48-4.63,5.06-8.2,1.25,1.73,3.36,4.73,6.75,6.46,2.99-2.99,2.95-4.8,3.89-7.78,1.51,3.1,3.44,4.67,6.83,6.41,2.99-2.99,2.61-6.7,3.46-9.3,1.43,2.11,3.25,3.58,5.19,3.94,1.48-1.93,2.56-5.03,2.55-7.83,2.79,1.99,5.38,2.59,7.14,2.72,.7-3.65,.55-6.46-.02-9.71,2.63,.82,3.13,1.57,6.36,1.58,2.16-7.23-.41-15.05-7.92-20.59l-6.05,6.96h.02Z"/>
